...
function addMarker(place)
{
    ...
    var marker = new MarkerWithLabel(
    {
        ...
        map: map,
        labelContent: "<i>" + place.place_name + "</i>, " + "<b>" + place.postal_code+ "</b>",
        icon: {
            url: "https://maps.google.com/mapfiles/kml/pal4/icon0.png",
            size: null,
            origin: null,
            anchor: null,
    ...
    google.maps.event.addListener(marker, 'click', function(){
        ...
        {	
            ...
            var content = place.place_name + ", " + place.admin_name1 + ", <i>" + place.postal_code + ".</i> <b>Local News:</b>"
            // content += ""
            content += "<ul type=\"square\">"
            // content += "<i>" + place.place_name + "</i>, " + "<b>" + place.postal_code+ "</b>
